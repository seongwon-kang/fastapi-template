...
[![codecov](https://codecov.io/gh/seongwon-kang/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/seongwon-kang/fastapi-template)
[![CI](https://github.com/seongwon-kang/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/seongwon-kang/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by seongwon-kang

## Install

from source
```bash
git clone https://github.com/seongwon-kang/fastapi-template fastapi_template
cd fastapi_template
make install
```
